    ...
    public partial class frmCalculadora : Form
    {
       ...
       public void limparCampos()
        ...
        private void btnCalcular_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (rdbDividir.Checked)
                    {
                        if (num2 == 0)
                        {
                            MessageBox.Show("Impossível dividir por 0", "Mensagem do Sistema", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
                            limparCampos();
                        }
                        else
                        {
            ...
            {
                MessageBox.Show("Favor inserir valores válidos", "Mensagem do sistema", MessageBoxButtons.OK , MessageBoxIcon.Error , MessageBoxDefaultButton.Button1);
                limparCampos();
            }
        }
    }
